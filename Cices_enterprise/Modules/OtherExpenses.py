...
class OtherExpenses(db.Model):
    ...
    def __init__(self, amount_spent, date_spent, spend_on, spend_by, details, recorded_at):
    ...
    def __repr__(self):
        return f"{self.amount_spent,self.date_spent, self.spend_by,self.spend_on, self.details, self.recorded_at}"
