...
def add_item():
    ...
    if form.validate_on_submit() and request.method == 'POST':
        new_items = Items(name=form.name.data, size=form.size.data,unit_sales = form.unit_sales.data,
                          ...
                          sales_per_stock = form.sales_per_stock.data,created_at=datetime.now(),
...
def item_details(_id):
    ...
    return render_template("item_details.html", values=Items.query.filter_by(_Id=_id).first(),stocks=stocks)
